      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <ul className="flex items-center justify-center text-sm text-gray-500 sm:mb-0">
                ...
                by <a className="hover:underline md:me-2" href = "https://prajwalp06.netlify.app/"> Prajwal P</a>| <a className="hover:underline md:me-2" href = "https://varunsathreya.github.io/"> Varun S Athreya</a></span>   
              </ul>
          </div>
          <hr className="my-3 border-gray-200 sm:mx-auto lg:my-8" />
          <span className="block text-gray-500 md:text-center md:text-sm text-xs text-center">© 2024 <a href="/" className="hover:underline">Care Taker</a>. All Rights Reserved.</span>
      </div>
    </footer>
  );
};
