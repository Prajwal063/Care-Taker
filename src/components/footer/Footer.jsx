  ...
  return (
    <footer className="bg-white rounded-lg shadow  m-4">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          ...
          <span className="block text-gray-500 sm:text-center md:text-sm sm:text-xs justify-center">© 2024 <a href="/" className="hover:underline">Care Take</a>. All Rights Reserved.</span>
      </div>
    </footer>
  );
};
